<template>
    <div>
        ...
        <div class="max-w-screen-lg mx-auto p-5">
            <div class="grid grid-cols-1 md:grid-cols-12 border rounded-xl overflow-hidden">
                <div class="bg-gray-900 md:col-span-4 p-10 text-white">
                    <h3 class="text-3xl sm:text-4xl leading-normal font-extrabold tracking-tight">
                        <p class="text-lg mb-2">Đây là cách liên hệ với</p>
                ...
                <div class="md:col-span-8 p-10">
                    <div class="flex flex-wrap -mx-3 mb-6">
                        <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                            ...
                            <input
                                class="appearance-none block w-full bg-gray-200 border-none text-gray-700 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white"
                        ...
                        <div class="w-full md:w-1/2 px-3">
                            ...
                            <input
                                ...
                                id="grid-last-name" type="text" placeholder="A">
                        </div>
                    </div>
                    <div class="flex flex-wrap -mx-3 mb-6">
